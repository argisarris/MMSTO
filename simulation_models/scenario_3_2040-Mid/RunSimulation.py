...
os.makedirs('../../plots/scenario_3_2040-Mid', exist_ok=True)
...
# ==========================
# Simulation (Scenario 3: 2040-Mid)
# ==========================
...
ax1.set_title('Ramp and Mainline Metrics - Thalwil (Scenario 3: 2040-Mid)')
...
plt.tight_layout()
plot_path = os.path.abspath('../../plots/scenario_3_2040-Mid/THA_mid.png')
...
ax1.legend(loc='upper left')
ax1.grid(True, alpha=0.3)
ax1.set_title('Ramp and Mainline Metrics - Horgen (Scenario 3: 2040-Mid)')
...
plt.tight_layout()
plot_path = os.path.abspath('../../plots/scenario_3_2040-Mid/HOR_mid.png')
if os.path.exists(plot_path):
    os.remove(plot_path)
plt.savefig(plot_path, dpi=300, bbox_inches='tight')
print(f"Saved plot: {plot_path}")
...
ax1.legend(loc='upper left')
ax1.grid(True, alpha=0.3)
ax1.set_title('Ramp and Mainline Metrics - Wädenswil (Scenario 3: 2040-Mid)')
...
plt.tight_layout()
plot_path = os.path.abspath('../../plots/scenario_3_2040-Mid/WAE_mid.png')
if os.path.exists(plot_path):
    os.remove(plot_path)
plt.savefig(plot_path, dpi=300, bbox_inches='tight')
print(f"Saved plot: {plot_path}")
...
# ==========================
print("=" * 60)
print("SCENARIO 3 SIMULATION SUMMARY (2040-Mid)")
print("=" * 60)
print(f"\nThalwil (THA):")
