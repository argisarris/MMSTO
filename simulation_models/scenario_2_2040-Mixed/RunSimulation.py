...
os.makedirs('../../plots/scenario_2_2040-Mixed', exist_ok=True)
...
# ==========================
# Simulation (Scenario 2: 2040-Mixed)
# ==========================
...
ax1.set_title('Ramp and Mainline Metrics - Thalwil (Scenario 2: 2040-Mixed)')
...
plt.tight_layout()
plot_path = os.path.abspath('../../plots/scenario_2_2040-Mixed/THA_mixed.png')
...
ax1.legend(loc='upper left')
ax1.grid(True, alpha=0.3)
ax1.set_title('Ramp and Mainline Metrics - Horgen (Scenario 2: 2040-Mixed)')
...
plt.tight_layout()
plot_path = os.path.abspath('../../plots/scenario_2_2040-Mixed/HOR_mixed.png')
if os.path.exists(plot_path):
    os.remove(plot_path)
plt.savefig(plot_path, dpi=300, bbox_inches='tight')
print(f"Saved plot: {plot_path}")
...
ax1.legend(loc='upper left')
ax1.grid(True, alpha=0.3)
ax1.set_title('Ramp and Mainline Metrics - Wädenswil (Scenario 2: 2040-Mixed)')
...
plt.tight_layout()
plot_path = os.path.abspath('../../plots/scenario_2_2040-Mixed/WAE_mixed.png')
if os.path.exists(plot_path):
    os.remove(plot_path)
plt.savefig(plot_path, dpi=300, bbox_inches='tight')
print(f"Saved plot: {plot_path}")
...
# ==========================
print("=" * 60)
print("SCENARIO 2 SIMULATION SUMMARY (2040-Mixed)")
print("=" * 60)
print(f"\nThalwil (THA):")
